...
class InitiativesTest < ApplicationSystemTestCase
  ...
  test "creating a Initiative" do
    ...
    fill_in "Alternative solution name", with: @initiative.alternative_solution_name
    fill_in "Anticipated carbon saving", with: @initiative.anticipated_carbon_saving
